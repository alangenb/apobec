...
pat=makeapn(load_struct(X.pat,'FINAL_DATASET.MIN.v3.2.pat.txt'));
mut1=makeapn(load_struct(X.mut,'FINAL_DATASET.MIN.v3.2.mut.part1.txt'));
mut2=makeapn(load_struct(X.mut,'FINAL_DATASET.MIN.v3.2.mut.part2.txt'));
mut=concat_structs({mut1,mut2});
ttype=makeapn(load_struct(X.ttype,'FINAL_DATASET.MIN.v3.2.ttype.txt'));
